...
| Training run planning | Scripted | `scripts/plan_training_run.py`; prints ordered commands from nuScenes manifest generation through satellite crops, camera pose targets, LiDAR supervision, manifest sample preview, split manifests, readiness, train, and eval |
