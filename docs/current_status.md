...
| Real nuScenes data loading | Missing | needs adapter for camera, calibration, ego pose, satellite patch, valid mask, optional LiDAR/map targets |
...
| Environment setup | Scripted | `requirements.txt`, `environment.yml`, `scripts/setup_env.sh` |
...
1. Implement the nuScenes sample adapter.
