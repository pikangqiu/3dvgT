...
- Occ3D/OpenScene/UniOcc provide public occupancy labels and evaluation language; the repository now has a lightweight class-IoU/mIoU evaluator for exported arrays, but real public semantic occupancy validation still depends on verified label export, class mapping, and split alignment.
