...
def build_experiment_protocol() -> ExperimentProtocol:
    ...
    return ExperimentProtocol(
        ...
        baselines=(
            ...
            ProtocolBaseline(
                name="UniSplat",
                family="feed-forward spatio-temporal 3D Gaussian reconstruction",
                satellite_conditioning="none",
                expected_artifact="dynamic-aware Gaussians from a 3D latent scaffold and streaming scene completion outputs",
                table="driving reconstruction table",
                experiment_phase="phase2_tracking",
            ),
            ProtocolBaseline(
                name="DenoiseGS",
                family="optimization-based dynamic driving 3D Gaussian reconstruction",
                satellite_conditioning="none",
                expected_artifact="nuScenes/Waymo dynamic 3DGS reconstruction and novel-view synthesis under noisy camera poses",
                table="driving reconstruction table",
                experiment_phase="phase2_tracking",
            ),
            ProtocolBaseline(
                name="Splat2BEV",
                family="Gaussian-assisted geometry-aligned BEV perception",
                satellite_conditioning="none",
                expected_artifact="explicit 3D Gaussian reconstruction features projected into BEV for downstream perception",
                table="satellite/BEV design ablation table",
                experiment_phase="phase3_stretch",
            ),
            ProtocolBaseline(
                name="GaussianOcc",
        ...
        benchmarks=(
            ...
            ProtocolBenchmark(
                name="UniSplat",
                role="feed-forward dynamic driving reconstruction baseline",
                source_url="https://openreview.net/forum?id=Ng2VDbKD4r",
                reason="ICLR 2026 feed-forward 3D reconstruction method using a 3D latent scaffold and spatio-temporal fusion for sparse, non-overlapping driving cameras.",
                experiment_phase="phase2_tracking",
            ),
            ProtocolBenchmark(
                name="DenoiseGS",
                role="dynamic driving 3DGS robustness baseline",
                source_url="https://ojs.aaai.org/index.php/AAAI/article/view/37640",
                reason="AAAI 2026 driving-scene 3DGS method on nuScenes/Waymo that directly targets noisy camera parameters and inaccurate dynamic-object trajectories.",
                experiment_phase="phase2_tracking",
            ),
            ProtocolBenchmark(
                name="Splat2BEV",
                role="geometry-aligned BEV reconstruction design reference",
                source_url="https://arxiv.org/abs/2603.19193",
                reason="2026 reconstruction-to-BEV method arguing that explicit 3D Gaussian reconstruction improves BEV perception on nuScenes and Argoverse.",
                experiment_phase="phase3_stretch",
            ),
            ProtocolBenchmark(
                name="M2-Occ",
